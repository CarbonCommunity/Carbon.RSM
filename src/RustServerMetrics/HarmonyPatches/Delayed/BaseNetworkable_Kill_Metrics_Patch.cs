...
[DelayedHarmonyPatch]
[HarmonyPatch]
internal static class BaseNetworkable_Kill_Metrics_Patch
{
    ...
    public static bool Prepare()
    {
        ...
        {
            Debug.Log("Note: Cannot patch BaseNetworkable_Kill_Metrics_Patch yet. We will patch it upon server start.");
            return false;
        }
    ...
    public static void Postfix(long __state)
    {
        ...
        MetricsLogger.Instance.ServerUpdate.LogTime("BaseNetworkable.Kill", ms);
    }
}
