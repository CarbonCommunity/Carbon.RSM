...
8. Download the latest version of Carbon.[Windows|Linux].RSM.dll from this projects [latest release](https://github.com/CarbonCommunity/Carbon.RSM/releases/tag/main_build) and copy it to the `carbon/managed/modules` folder in your Carbon server directory
